  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen bg-black">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* Navbar */}
        <header className="w-full border-b border-border-dark bg-background-dark/90 backdrop-blur-md sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-primary flex items-center justify-center rounded-sm text-black">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button 
                        ...
                        className="bg-primary hover:bg-white text-black text-sm font-bold px-4 py-2 rounded transition-colors duration-200 flex items-center gap-2"
                    >
